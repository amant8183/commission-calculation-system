...
class Agent(db.Model):
    ...
    children = db.relationship('Agent', backref=db.backref('parent', remote_side=[id]), lazy=True)
...
def add_agent():
    ...
    new_agent = Agent(name=data['name'], level=data['level'], parent_id=data.get('parent_id'))
